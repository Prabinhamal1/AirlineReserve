...
@section('main-content') 
    <div class="flex-1 mx-auto p-6 border mt-10 bg-white m-[40px] ml-[40px] h-[400px] mr-[40px] rounded-lg shadow-lg">
        <div class="flex justify-between mb-6">
            <h1 class="text-2xl font-semibold text-gray-800">ADD Cities</h1>
        ...
        <form action="{{url('/admin/city/store')}}" method="post">
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-1">
                ...
                <div class="flex flex-col">
                    ...
                    <input type="text" id="name" name="name" class="mt-1 p-2 border rounded-md shadow-sm focus:outline-none focus:border-indigo-500 focus:ring-indigo-500 focus:ring-1" placeholder="Add Cities">
                </div>
                <div class="flex flex-col">
                    <label for="name" class="text-gray-700">Code</label>
                    <input type="text" id="name" name="code" class="mt-1 p-2 border rounded-md shadow-sm focus:outline-none focus:border-indigo-500 focus:ring-indigo-500 focus:ring-1" placeholder="Enter Cities Code">
                </div>
