...
<section class="  mt-10 border shadow-5xl w-full mx-auto max-h-full my-8">
  <div class="bg-white p-6 rounded-lg shadow-lg">
    ...
    <div class="flex justify-between items-center mb-4">
      <h2 class="text-lg font-bold">COSTUMER LIST</h2>
      <a href="{{route('costumer.register')}}">
      ...
      <table class="w-full bg-white rounded-lg border border-gray-200">
        <thead>
          <tr class="bg-gray-50 border-b border-gray-200">
            ...
            <th class="py-4 px-4 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Phone</th>
            <th class="py-4 px-4 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Email</th>
            <th class="py-4 px-4 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Address</th>
        ...
        <tbody>
          ...
          <tr>
            <td  class="py-4 px-4 text-center text-gray-500">{{$user->id}}</td>
            <td  class="py-4 px-4 text-center text-gray-500">{{$user->name}}</td>
            <td  class="py-4 px-4 text-center text-gray-500">{{$user->phone}}</td>
            <td  class="py-4 px-4 text-center text-gray-500">{{$user->email}}</td>
            <td  class="py-4 px-4 text-center text-gray-500">{{$user->address}}</td>
            <td class="py-4 px-1 text-center text-gray-500">
              <a href="{{route('costumer.edit',$user->id)}}" class="flex justify-center">
                  <img class="h-8 w-8" src="{{ URL::asset('/images/edit.png') }}" alt="Edit">
              </a>
          </td>
            <td class="py-4 px-1 text-center text-gray-500 my-8">
              <a href="{{route('costumer.delete',$user->id)}}"class="flex justify-center">
