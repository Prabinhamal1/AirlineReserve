    ...
    <div class="bg-white p-6 rounded-lg shadow-lg">
      ...
      <form class="space-y-6" enctype="multipart/form-data">
        ...
        <div class="flex flex-col space-y-2">
          ...
          <input type="text" id="name" class="border border-gray-300 rounded-md p-2 text-sm focus:ring focus:ring-blue-200 focus:border-blue-400" placeholder="Enter airline name" required>
        </div>

        <!-- Code Input -->
        <div class="flex flex-col space-y-2">
          <label for="code" class="text-sm font-medium text-gray-700">Code</label>
          <input type="text" id="code" class="border border-gray-300 rounded-md p-2 text-sm focus:ring focus:ring-blue-200 focus:border-blue-400" placeholder="Enter airline code" required>
        </div>
        </div>
